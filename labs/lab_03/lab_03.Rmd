...
A2: Zip code 25301 had the most loans, totaling $160,721,321. JACKSON KELLY PLLC received the biggest loan in that zip code, totaling $5,068,472. It is located in Kanawha County, which encompasses the city of Charleston and congressional district WV-02. $5,126,618.6 of the loan was forgiven, which is more than the loan amount itself. I would guess a clerical error is the reason for the discrepency. I originally wondered if the difference was equal to the distance between the initial amount approved and the final amount paid, but those numbers are not the same. I'm not sure if interest played a role but 50,000 in interest doesn't seem right either.
