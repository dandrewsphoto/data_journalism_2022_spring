...
**Answer** A dataframe of 152k tweets from senators and representatives about the pandemic.
...
#anything that begins with http, get rid of that and replace it with nothing
#this gets rid of links so that they don't show up as fake words
```
...
**Answer** reduces this to a list of unique instances of each item on the list.

```{r}
a_list_of_words <- c("Dog", "dog", "dog", "cat", "cat", ",")
unique(a_list_of_words)
#reduces this to a list of unique instances of each item in the list.
#tidytext has unnest_tokens that will lowercase all the text and remove all the punctuation. 
```
...
**Answer** makes a list of unique words for each item that appears in every tweet. 
...
**Answer** not interesting, the top results are all junk words. prepositions and filler words.
...
**Answer** definitely more interesting! now its a list of topical words, different iterations of covid 19 and heath care, pandemic, etc.
...
**Answer** Top 10 words tweeted in 2020 vs 2021. 2020 has a bunch of different covid/coronavirus, and ends with crisis. 2021 has vaccine as one of the top results, along with health and relief.
...
**Task** Run the following code and describe the results.
**Answer** list of top two combined words in 2020, including covid 19, heath care, etc.
...
**Task** Run the following code and describe the results.
**Answer** top 2 word phrases for 2021. Covid 19 still in the lead, but public heath has fallen a bit. Vaccines are on the rise!
...
**Task** Run the following code and describe the results.
**Answer** The most frequent 2 word phrases by Democrats and Republicans. public health, town hall, relief package vs cares act.
...
**Task** Run the following code and describe the results.
**Answer** Trump disappears from 2020 to 2021. Nursing homes, god bless american people in 2020. Covid relief, vaccines are on the rise in 2021.
...
**Answer** Interesting that Trump was marked as positive. Most seem right.
