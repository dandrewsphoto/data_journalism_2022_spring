...
**Notes** -> adding the data horizontally 
```{r}
...
#naics codes are industry codes that explain what the business type is.
#should have these open as we're going through the data
```
...
#start with PPP loan, left join the naices_codes BY the "naics_code," a column that appears in both datasets.
#then select just the name, naics_code and title, and counts how many rows were joined (nrow).
```
...
#Zip Code Tabulation Area - what the cenus bureau cares about
#Zip Codes - what the post office cares about--> usually has 9 didgits.
#usually the same thing, but sometimes are different. Any story that talks about the "demographics" in a zip code, they're really talking about the zip code tabulation area. 
```
...
Basically, it can't join a charater field to a number field.
...
**Answer** Every row now has the ability to have demographic data, since demographic columns were added to the new dataset. BUT a lot of them are N/A, so I can't say for sure if every row has demographic data or not. 
...
**Answer** Yes! It now has percentages.
...
**Answer** 
Number of loans that went to ZCTAs with more than 50% non-Hispanic Black population: 41968
Average amount: 55546.84
Median amount: 19949
...
**Answer**
number of PPP loans that went to ZCTAs with more than 50% non-Hispanic white population: 112056	
Average amount: 89194.67	
Median amount: 20833	
...
**Answer**
number of PPP loans that went to ZCTAs with more than 50% non-Hispanic Black population in urban areas:
Number of loans: 145
Average Amount: 44815.22	
Median: 19064.57	

number of PPP loans that went to ZCTAs with more than 50% non-Hispanic Black population in rural areas:
Number of loans: 41823	
Average Amount: 55584.05
Median Amount: 19950.00
...
Loans that went to ZCTAs with more than 50% non-Hispanic white population in rural areas:
Number of loans: 18083
Average Amount: 74463.32
Median Amount: 20833

Loans that went to ZCTAs with more than 50% non-Hispanic white population in urban areas:
Number of loans: 93973
Average Amount: 92029.39
Median Amount: 20833
