...
# this is arranging the lowest percent payroll WITH the highest loan amounts. This gives you results that show people got 1.7 million but used 0% of it to cover payroll. So you would then look up who that loan went to, and start asking them about their loan.
```
...
**Answer** character, or <chr>, in the format of "2020-05-01".                    
...
**Answer** This codeblock gave me an error, but the datatype for date approved was still <chr> or character, and CleanDate was <dttm>, or date + time, or an instance in time.
...
```
What is the datatype for `date_approved` (it's just to the right of the column name)? Put your answer in the space below.
**Answer** <date>, in the format of 2020-04-10.
